    ...
    >
      ...
      <div className="relative flex h-full max-w-6xl mx-auto flex-col justify-end px-4 pb-8">
        <div className="flex items-center gap-2">
          <p className="text-sm font-medium text-ter uppercase tracking-wide">Featured</p>
          {series.memberOnly && (
        ...
        <h2 className="mt-1 text-2xl font-semibold tracking-tight text-white sm:text-4xl">
          {series.title}
        </h2>
        {series.description && (
        ...
        <span
          className="mt-4 inline-flex w-fit items-center rounded-full px-5 py-2 text-sm font-semibold text-white transition group-hover:brightness-110"
