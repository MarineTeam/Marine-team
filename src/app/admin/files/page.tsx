  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-xs text-zinc-500">Max 4MB (server upload limit). For larger files, upload via the Bunny dashboard and link the URL directly.</p>
      </form>
      ...
      <ul className="divide-y divide-zinc-200 dark:divide-zinc-800 rounded-lg border border-zinc-200 dark:border-zinc-800">
        ...
        {files.length === 0 && <li className="p-4 text-sm text-zinc-500">No files yet.</li>}
      </ul>
    </div>
  );
}
